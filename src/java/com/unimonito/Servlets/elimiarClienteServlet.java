 ...
 * @author DAVID
 */
@WebServlet(name = "elimiarClienteServlet", urlPatterns = {"/elimiarClienteServlet"})
public class elimiarClienteServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            response.sendRedirect("vistas/eliminarCliente.jsp?respuesta=si&mensaje=" + mensaje);
        }
    }
